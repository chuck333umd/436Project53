    ...
    override fun onStart() {
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val mAdapter = MyJobsAdapter(this@MyJobs, jobsCreated!!,description!!,dollar!!,dueDate!!,location!!,createdBy!!)
        ...
        listView.onItemClickListener = AdapterView.OnItemClickListener { _, _, item, _ ->
            ...
            ref.addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val intent = Intent(this@MyJobs, ViewJob::class.java)
